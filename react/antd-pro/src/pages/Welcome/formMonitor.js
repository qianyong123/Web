...
@Form.create({
  mapPropsToFields({
    item: { amount, gender, name, num, organization, phone, status = '1' } = {},
  }) {
...
class FormMonitor extends PureComponent {
  static propTypes = {
    item: object,
      ...
      >
        <Form {...FORM_ITEM_LAYOUT} className={globalStyles.modalForm} onSubmit={this.handleSubmit}>
          ...
          <Form.Item label="监测地块数">
            ...
            })(<Input disabled placeholder="请输入监测地块数" />)}
          </Form.Item>
